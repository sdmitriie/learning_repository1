        ...
        if not letter_in_word.isalpha() and letter_in_word != ' ':
            ...
            for letter_in_alphabet in alpha_upper:
                if letter_in_word == letter_in_alphabet:
                    if (alpha_upper.index(letter_in_alphabet) + caesar_key + 1) <= len(alpha_upper):
                        new_words += alpha_upper[alpha_upper.index(letter_in_alphabet) + caesar_key]
                        break
                    
                    else:
                        new_words += alpha_upper[alpha_upper.index(letter_in_alphabet) - len(alpha_upper) + caesar_key]
                        break
        elif letter_in_word.islower():
            for letter_in_alphabet in alpha_lower:
                if letter_in_word == letter_in_alphabet:
                    if (alpha_lower.index(letter_in_alphabet) + caesar_key + 1) <= len(alpha_lower):
                        new_words += alpha_lower[alpha_lower.index(letter_in_alphabet) + caesar_key]
                        break
                    
                    else:
                        new_words += alpha_lower[alpha_lower.index(letter_in_alphabet) - len(alpha_lower) + caesar_key]
                        break
    return new_words
